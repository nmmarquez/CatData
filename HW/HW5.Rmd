...
$$
\begin{aligned}
\text{log} \frac{P(\text{Chron's} = \text{No}|\text{SNP} = \text{BB})}
    {P(\text{Chron's} = \text{Yes} | \text{SNP} = \text{BB})} &=
    \text{log}(m_{21}) - \text{log}(m_{11}) \\
&=(u_{1(2)} - u_{1(1)}) + (u_{12(21)} - u_{12(11)}) \\
&= \beta_0 \\
\text{log} \frac{P(\text{Chron's} = \text{No}|\text{SNP} \neq \text{BB})}
    {P(\text{Chron's} = \text{Yes} | \text{SNP} \neq \text{BB})} &=
